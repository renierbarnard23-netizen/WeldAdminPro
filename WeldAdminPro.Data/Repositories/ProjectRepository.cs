...
CREATE TABLE IF NOT EXISTS ProjectSettings (
	...
	Value TEXT NOT NULL
		...
		public Project? GetById(Guid id)
		{
			...
			using var cmd = connection.CreateCommand();
			cmd.CommandText = "SELECT * FROM Projects WHERE Id = @Id AND IFNULL(IsArchived,0)=0";
		...
		// ================= CREATE =================
			...
			private bool JobNumberExists(SqliteConnection connection, int jobNumber)
        {
            using var cmd = connection.CreateCommand();
...
WHERE JobNumber = @JobNumber;";
        ...
        public void Add(Project project)
		{
            ...
            while (JobNumberExists(connection, project.JobNumber))
            {
                project.JobNumber++;
            }          
...
WHERE Id = @Id;";
		...
		private int GetNextJobNumberInternal(SqliteConnection connection)
		{
            ...
            if (result == null)
            {
                UpdateNextJobNumber(connection, 2);
                return 1;
            }
