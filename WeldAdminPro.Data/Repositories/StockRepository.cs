	...
	public class StockRepository
	{
		...
		public void AddTransaction(StockTransaction tx)
		{
          ...
          WHERE Id = $id;";
			...
			stockCmd.Parameters.AddWithValue("$delta", tx.Quantity); // 🔑 signed delta
