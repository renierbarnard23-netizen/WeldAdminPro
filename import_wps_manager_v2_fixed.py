"""
WeldAdmin Pro - Import & Records (v2-fixed)
-------------------------------------------
- Adds the missing RecordsTab.delete_selected() method
- Keeps Save actions in menu, toolbar, footer, and Ctrl+S shortcut

Run:
    python import_wps_manager_v2_fixed.py
"""
...
APP_TITLE = "WeldAdmin Pro - Import & Records (v2-fixed)"
