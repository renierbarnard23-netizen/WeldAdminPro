...
namespace WeldAdminPro.UI.ViewModels
{
	public partial class ProjectsViewModel : ObservableObject
	{
        ...
        public Action<Project>? ProjectSelected;
        ...
        public ProjectsViewModel()
        {
			...
			_projectContextService = App.ProjectContextService;
        ...
        partial void OnSelectedProjectChanged(Project? value)
        {
            ...
            _projectContextService.SetCurrentProject(value);

            if (value != null)
            {
                ProjectSelected?.Invoke(value);
            }
        }
